...
function Paid_ads_Result_In_Number() {
  return (
    <section className="py-16 md:py-24 bg-white overflow-hidden relative">
      ...
      <div className="global-container md:px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 justify-between gap-6 mb-10">
          ...
          <motion.p
            {...fadeUp(0.15)}
            className="text-[16px] text-zinc-600 leading-relaxed text-left md:text-right"
          >
            We measure success by business outcomes rather than vanity metrics.
          </motion.p>
        </div>
...
export default Paid_ads_Result_In_Number;
