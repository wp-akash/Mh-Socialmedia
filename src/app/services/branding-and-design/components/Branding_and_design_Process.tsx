...
const features = [
    {
        id: "01",
        title: "Discovery",
        description: "Business, market, audience, competitors and objectives.",
        accent: "#6366f1", // indigo
    },
    {
        id: "02",
        title: "Strategy",
        description: "Positioning, personality, differentiation, messaging and creative direction.",
        accent: "#a855f7", // purple
    },
    {
        id: "03",
        title: "Concept",
        description: "Strategic creative territories—not random design options.",
        accent: "#10b981", // emerald
    },
    {
        id: "04",
        title: "Design",
        description: "Development of the core visual identity.",
        accent: "#ef4444", // red
    },
    {
        id: "05",
        title: "System",
        description: "Building the complete design language.",
        accent: "#f59e0b", // amber
    },
    {
        id: "06",
        title: "Application",
        description: "Showing how the brand works across real customer touchpoints.",
        accent: "#3b82f6", // blue
    },
    {
        id: "07",
        title: "Guidelines",
        description: "Documenting the rules for consistency.",
        accent: "#ec4899", // pink
    },
    {
        id: "08",
        title: "Launch",
        description: "Helping translate the identity across your customer-facing ecosystem.",
        accent: "#14b8a6", // teal
    },
];

const Branding_and_design_Process = () => {
                    ...
                    {features.map((feature, index) => {
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    flex: isActive ? "0 0 30%" : isInactive ? "0 0 10%" : "1",
...
export default Branding_and_design_Process;