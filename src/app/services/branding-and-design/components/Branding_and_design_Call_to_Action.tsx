...
const Branding_and_design_Call_to_Action = () => {
    return (
        <section
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                <motion.div {...fadeUp(0)}>
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-[400] tracking-widest uppercase text-white bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 mb-5">
                        <span className="text-[#25D366]">✦</span> Paid ADS
                    </span>
                </motion.div>
                ...
                >
                    Your customers experience your brand everywhere—Google, Instagram, TikTok, your website, advertisements, packaging, presentations, stores and increasingly AI-powered interfaces.
                    Your brand therefore needs to become more than a logo.
                    It needs to become a recognizable system that communicates who you are, why you matter, what makes you different and why customers should trust you.
                    At MH Social, we combine strategy, creative direction, design systems and AI-enabled production to build brands for the modern market.
...
export default Branding_and_design_Call_to_Action;
