...
const processSteps = [
  {
    ...
    desc: "We don't design before understanding your business, audience, competitors and objectives.",
  },
  {
    title: "Design Built for Marketing",
    desc: "Your brand isn't created just to look good inside a presentation. It is built to perform across real campaigns and customer touchpoints.",
  },
  {
    title: "Digital-First Thinking",
    desc: "We design for: Web + Search + Social + Mobile + Ads + E-commerce + Video + AI",
  },
  {
    title: "Human Creativity + AI Acceleration",
    desc: "AI can accelerate concept exploration, visual ideation, localization and production. But strategy, cultural understanding, taste and creative judgment remain human responsibilities. Our approach is: Human Strategy + Creative Direction + AI Acceleration + Human Judgment.",
  },
  {
    title: "Built for Scale",
    desc: "We create systems rather than isolated designs, allowing your brand to remain consistent as your business, team and content production grow.",
  }
];
...
function Branding_and_design_core_service() {
...
export default Branding_and_design_core_service;
