...
export default function Paid_ads_Hero_Section() {
    return (
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            A logo is not a brand. A colour palette is not a brand. And a beautiful social media post isn't a brand either.
                            Your brand is the feeling people remember when they see your name, experience your product, visit your website, or interact with your business.
                            At MH Social, we build brands designed to be recognized, remembered, trusted and chosen. From brand strategy and positioning to visual identity, logo design, packaging, social media, website UI and complete brand guidelines, we create connected brand systems that work across every customer touchpoint.
                        </p>
