          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="">
              ...
              <p className="paragraph mt-3 primary_header_content">
                We develop specialized advertising strategies for:
                Real Estate, Hospitality, Healthcare, E-commerce, Automotive, Education, Finance, Construction, Technology, Restaurants, Professional Services
                Every industry has different customers, buying journeys and economics—so every advertising strategy needs to be built accordingly.
...
export default Paid_ads_Investment;
