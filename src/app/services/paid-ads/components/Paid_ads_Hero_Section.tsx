            ...
            <div className="global-container md:px-4">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        ...
                        >
                            Turn Your Ad Budget Into Measurable Growth
                        </motion.h1>
                        <Link
                            href="/contact"
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Your customers are searching on Google, scrolling Instagram, watching YouTube, discovering products on TikTok and researching businesses on LinkedIn.<br /> MH Social builds and manages performance advertising campaigns for Dubai and GCC businesses—focused on leads, sales, bookings, customers, revenue and ROAS, not just clicks and impressions.
