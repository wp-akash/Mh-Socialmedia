...
const processSteps = [
  {
    ...
    desc: "We don't start by asking how much you want to spend. We start by understanding what you want to achieve and what the economics of customer acquisition look like.",
  },
  {
    title: "Performance Over Vanity Metrics",
    desc: "Impressions, clicks and engagement matter—but ultimately, we focus on leads, customers, sales, revenue and profitability.",
  },
  {
    title: "Creative + Media Together",
    desc: "The best targeting cannot rescue weak creative, and great creative cannot compensate for broken tracking. We connect both.",
  },
  {
    title: "Full-Funnel Advertising",
    desc: "We can build campaigns across: Awareness → Consideration → Conversion → Retention",
  },
  {
    title: "Data-Driven Optimization",
    desc: "Our approach is: Data → Hypothesis → Test → Result → Decision. We continuously evaluate spend, CTR, CPC, CPM, conversion rate, CPA, CPL, ROAS, audience performance, creative performance and landing-page results.",
  },
  {
    title: "Arabic & Multilingual Advertising",
    desc: "Dubai's diverse audience often requires different creative and messaging for English-speaking, Arabic-speaking, South Asian and international audiences.",
  },
  {
    title: "AI-Ready Advertising",
    desc: "Advertising platforms are increasingly automated. We focus on providing stronger inputs—creative diversity, conversion signals, first-party data, offers and quality landing pages—so automated systems have better information to optimize from.",
  },
];
