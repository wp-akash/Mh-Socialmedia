    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                >
                    Ready to Turn Ad Spend Into Growth?
                </motion.h2>
                ...
                >
                    Your competitors are already bidding on keywords, appearing in social feeds, running video campaigns and retargeting potential customers.
                </motion.p>
...
export default Paid_ads_Call_to_Action;
