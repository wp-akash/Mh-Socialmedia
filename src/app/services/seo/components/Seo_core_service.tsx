...
const processSteps = [
  {
    title: "Built for AI & Generative Search",
    desc: "We align with Google's guidance on AI search features by creating unique, reliable, people-first content designed for long-term discoverability.",
  },
  {
    title: "Enterprise Capabilities",
    desc: "We handle heavy lifting across strategy, technical audit, content, authority building, local setup, and conversion rate optimization.",
  },
  {
    title: "Commercial Outcome Focus",
    desc: "We look beyond vanity metrics like raw traffic. We focus on commercial intent, lead acquisition, and genuine ROI for your business.",
  }
];
      ...
      <div className="global-container md:px-4">
        ...
        <motion.div {...fadeUp(0)} className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <h3 className="h3 primary_header">
            Why Dubai Brands Trust MH Social
          </h3>
