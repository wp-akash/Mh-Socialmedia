...
export default function Google_Hero_Section() {
    return (
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Modern Search Optimization
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                        ...
                        >
                            SEO Dubai Agency | SEO Services in UAE
                        </motion.h1>
                        <Link
                            href="/contact"
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            This Could Be the Start of Something Incredible! What if your next customer is already searching for exactly what you sell—but they never find you?
                        </p>

                        <p className="text-sm text-zinc-500 leading-relaxed">
                            <b className="text-[#117C75]">99% Internet Penetration in UAE</b>  DataReportal recorded 11.3 million internet users in the UAE. Your customers are online right now—searching, comparing, and asking Google questions.
                        </p>
