            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                <motion.div {...fadeUp(0)}>
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-[400] tracking-widest uppercase text-white bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 mb-5">
                        <span className="text-[#25D366]">✦</span> Search Engine Optimization
                    </span>
                </motion.div>
                ...
                >
                    Catch the Success Your Next Win Starts Here
                </motion.h2>
                ...
                >
                    Your competitors are already building organic visibility and preparing for AI search. Let's build a digital presence that gets discovered across every touchpoint.
                </motion.p>
