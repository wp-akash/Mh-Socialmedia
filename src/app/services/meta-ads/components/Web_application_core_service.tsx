...
const processSteps = [
  {
    title: "We optimize for revenue, not vanity",
    desc: "Impressions don't pay the bills. We build every campaign around your real business goal — leads, sales, or bookings — and report on cost per result, not likes.",
  },
  {
    title: "We know UAE benchmarks",
    desc: "A \"good\" cost per lead in Dubai isn't the global number. Real estate, finance, and healthcare typically run AED 30–150 per lead, while e-commerce and education can land at AED 8–40. We know what strong performance looks like in your category — and how to get you there.",
  },
  {
    title: "We fix the whole funnel",
    desc: "Great ads sent to a weak landing page waste money. Improving a landing page from a 3% to 8% conversion rate can cut cost per lead by over 60% — the equivalent of a massive CPM reduction, at a fraction of the cost. We optimize creative and conversion.",
  },
  {
    title: "We test relentlessly",
    desc: "New creative, new audiences, new angles — we run structured A/B tests and shift budget to winners, so performance improves month over month instead of decaying into ad fatigue.",
  },
  {
    title: "We speak the market",
    desc: "With 40% of UAE audiences preferring Arabic content, we build bilingual campaigns that reach audiences most English-first advertisers miss.",
  },
];
