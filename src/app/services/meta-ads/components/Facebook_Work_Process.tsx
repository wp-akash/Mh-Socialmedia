...
const features = [
    {
        ...
        description: "We review your account (or build it right), define goals, and map your audience and offer.",
    ...
    },
    {
        ...
        description:
            "We produce scroll-stopping ad creative, write conversion-focused copy, and configure pixel, events, and tracking properly.",
    ...
    },
    {
        ...
        title: "Launch & Learn",
        description:
            "We launch across Advantage+ placements, let Meta optimize, and read the data closely through the learning phase.",
    ...
    },
    {
        ...
        description:
            "We cut what doesn't work, double down on winners, and scale spend while protecting your cost per result.",
        accent: "#ef4444", // red
    },
];

const Facebook_Work_Process = () => {
...
export default Facebook_Work_Process;