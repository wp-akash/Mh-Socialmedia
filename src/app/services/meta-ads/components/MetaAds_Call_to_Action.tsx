            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                <motion.div {...fadeUp(0)}>
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-[400] tracking-widest uppercase text-white bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 mb-5">
                        <span className="text-[#25D366]">✦</span> META ADS
                    </span>
                </motion.div>
                ...
                >
                    Let&apos;s build Facebook and Instagram campaigns that deliver real, measurable results for your brand in Dubai and across the GCC. Book your free ad account audit today  we&apos;ll show you exactly where the opportunities are.
                </motion.p>
...
export default MetaAds_Call_to_Action;
