...
export default function Meta_Hero_Section() {
    return (
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Meta Ads
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                        ...
                        >
                            Meta Ads That Turn Scrolls Into Sales
                        </motion.h1>
                        <Link
                            href="/contact"
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Reach the right people on Facebook and Instagram and turn them into leads, bookings, and buyers. MH Social builds data-driven Meta Ads campaigns for Dubai and GCC brands that lower your cost per result and scale what works.
                        </p>
