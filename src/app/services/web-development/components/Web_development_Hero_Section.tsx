...
export default function Web_development_Hero_Section() {
    return (
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Web Development
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Your website is more than a digital address. It's your 24/7 salesperson, storefront, brand experience, credibility engine and conversion platform.<br />
                            MH Social builds high-performance websites for Dubai and GCC businesses—from corporate and WordPress websites to e-commerce stores, real estate platforms and custom web applications—combining design, UX, technology, SEO, performance and conversion strategy.
