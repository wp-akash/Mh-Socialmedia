...
import { TrendingUp, Users, BarChart3, Zap, Mail, ShoppingCart, DollarSign } from "lucide-react";
...
const stats = [
  ...
  {
    value: "↑ Enquiries",
    label: "Increase in Enquiries / Bookings",
    icon: Mail,
    accent: "#d97706",
    ...
    <section className="py-16 md:py-24 bg-white overflow-hidden relative">
      ...
      <div className="global-container md:px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 justify-between gap-6 mb-10">
          ...
          >
            We measure website success through business outcomes—not screenshots.
          </motion.p>
        </div>
        ...
        >
          Results vary by industry, project scope, and starting point. We&apos;ll share
          relevant benchmarks for your specific sector during the consultation.
        </motion.p>
      </div>
    </section>
  );
