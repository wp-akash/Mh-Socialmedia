...
const features = [
    {
        ...
        description: "We analyze your business, audience, competitors, current social presence, content and advertising performance.",
    ...
    },
    {
        ...
        title: "Strategy",
        description:
            "We develop your platform strategy, audience approach, content pillars, campaign themes, creative direction, paid media plan and KPIs.",
    ...
    },
    {
        ...
        description:
            "We turn strategy into posts, carousels, Reels, Stories, videos, UGC and campaign assets.",
    ...
    },
    {
        ...
        description:
            "Content is adapted for each platform rather than simply copied everywhere.",
        accent: "#f59e0b", // amber
    },
    {
        id: "05",
        ...
        description:
            "Strong-performing content can be supported through paid campaigns while we continuously test creative, audiences, offers and placements.",
        accent: "#ef4444", // red
    },
    {
        id: "06",
        title: "Measure & Scale",
        description:
            "We analyze performance, identify what worked, improve what didn't and scale the strongest opportunities.",
        accent: "#117C75", // teal
    },
];

const Google_Work_Process = () => {
...
export default Google_Work_Process;