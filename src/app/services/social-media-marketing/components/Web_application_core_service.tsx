...
const processSteps = [
  {
    ...
    desc: "We don't believe posting more automatically means growing more. Every campaign and content system starts with a clear business objective.",
  },
  {
    title: "Built for Video-First Social",
    desc: "Reels, TikTok, Shorts, Stories and UGC are central to modern social discovery. We create content systems designed for how people consume media today.",
  },
  {
    title: "Organic + Paid Together",
    desc: "Organic content builds brand, trust and community. Paid media adds reach, targeting, scale and conversion. We use both where they make commercial sense.",
  },
  {
    title: "Data-Driven Creative",
    desc: "We look beyond likes. Watch time, completion, shares, saves, clicks, leads, purchases and revenue help determine what we create next.",
  },
  {
    title: "Arabic & Multilingual Expertise",
    desc: "Dubai is multilingual. We can adapt messaging, captions, creative, video, voiceovers and campaigns for English, Arabic and other relevant audiences.",
  },
  {
    title: "AI-Ready Marketing",
    desc: "As platforms increasingly use AI for recommendations, advertising and creative optimization, we focus on providing stronger creative, offers, audience signals and conversion data.",
  },
];
