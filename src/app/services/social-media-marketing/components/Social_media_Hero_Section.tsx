                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Social Media Marketing
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                        ...
                        >
                            Get Seen. Get Remembered. Get Chosen.
                        </motion.h1>
                        <Link
                            href="/contact"
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Your customers are already scrolling, watching, searching and discovering brands on social media. MH Social helps Dubai and GCC businesses turn that attention into brand awareness, engagement, leads and sales through strategy, creative content, short-form video, paid social and performance marketing.
                        </p>
