...
const GoogleAds_Call_to_Action = () => {
    return (
        <section
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                <motion.div {...fadeUp(0)}>
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-[400] tracking-widest uppercase text-white bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 mb-5">
                        <span className="text-[#25D366]">✦</span> Social Media Marketing
                    </span>
                </motion.div>
                ...
                >
                    Your customers are scrolling. Your competitors are publishing. Creators are influencing decisions. Algorithms are recommending content. Let's build a social media system that gets your brand seen, remembered and chosen—and connects attention to real business growth.
...
export default GoogleAds_Call_to_Action;
