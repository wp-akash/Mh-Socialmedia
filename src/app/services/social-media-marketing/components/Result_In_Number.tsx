...
import { TrendingUp, TrendingDown, Users, BarChart3, Eye, PlayCircle, DollarSign, ShoppingCart } from "lucide-react";
...
const stats = [
  ...
  {
    value: "80%",
    label: "Engagement & video performance",
    icon: PlayCircle,
    accent: "#7c3aed",
    ...
    <section className="py-16 md:py-24 bg-white overflow-hidden relative">
      ...
      <div className="global-container md:px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 justify-between gap-6 mb-10">
          ...
          >
            Our goal isn't simply more followers or impressions. We focus on measurable business outcomes.
          </motion.p>
        </div>
