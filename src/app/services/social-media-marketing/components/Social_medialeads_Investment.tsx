          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="">
              ...
              <p className="paragraph mt-3 primary_header_content">
                We develop industry-specific strategies for:
                Real Estate · Hospitality · Healthcare · E-commerce · Beauty & Fashion · Automotive · Finance · Technology · Education · Construction · Restaurants · Professional Services
                Different industry. Different audience. Different content. Different strategy.
...
export default Googleads_Investment;
