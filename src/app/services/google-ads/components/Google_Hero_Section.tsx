                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Google Ads
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                        ...
                        >
                            Get in Front of Customers the Moment They're Ready to Buy
                        </motion.h1>
                        <Link
                            href="/contact"
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Google Ads puts your business at the top of search results exactly when people are looking for what you offer. MH Social builds and manages high-performing Search, Display, Video, and Shopping campaigns for Dubai and GCC brands — engineered for leads, sales, and measurable ROI.
                        </p>
