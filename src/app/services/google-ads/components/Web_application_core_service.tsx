...
const processSteps = [
  {
    title: "We know UAE CPCs — and how to control them",
    desc: "Dubai clicks aren't cheap: real estate and legal keywords can run AED 20–45+, while niche B2B and long-tail terms stay under AED 8. We structure campaigns to win the clicks that convert and skip the ones that don't.",
  },
  {
    title: "We optimize for Quality Score",
    desc: "Better ad relevance and landing pages mean Google charges you less for the same positions. We treat Quality Score as a cost lever, not an afterthought.",
  },
  {
    title: "We build proper landing pages",
    desc: "Sending paid traffic to a weak page wastes money. We create and optimize dedicated landing pages that turn expensive clicks into leads and sales.",
  },
  {
    title: "We use budget where it converts.",
    desc: "Campaigns under roughly AED 3,000/month often can't exit Google's learning phase in this high-CPC market. We recommend budgets that actually accumulate the data needed to optimize — and structure spend around premium locations like Business Bay, DIFC, and free zones rather than wasting it on low-intent traffic.",
  },
  {
    title: "We run bilingual campaigns.",
    desc: "English and Arabic variants capture more of the market at lower cost and higher relevance.",
  },
  {
    title: "We know when not to use Performance Max.",
    desc: "We hold off on automated campaign types until you have enough conversion data (typically 30+/month) for them to actually perform — instead of letting the algorithm burn budget blind.",
  },
];
