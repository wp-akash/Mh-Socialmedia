...
const features = [
    {
        ...
        description: "We review your account (or build it correctly) and run deep keyword and competitor research across English and Arabic",
    ...
    },
    {
        ...
        description:
            "We build tightly themed campaigns, write high-Quality-Score ad copy, set conversion tracking, and prepare landing pages.",
    ...
    },
    {
        ...
        title: "Launch & Learn",
        description:
            "We launch, monitor the auction closely, prune wasted spend, and refine bids and keywords continuously.",
    ...
    },
    {
        ...
        description:
            "We scale winning campaigns, expand into new keywords and channels, and report clearly on cost per lead and ROI.",
        accent: "#ef4444", // red
    },
];
