            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
                ...
                <motion.div {...fadeUp(0)}>
                    <span className="inline-flex items-center gap-1.5 text-[11px] font-[400] tracking-widest uppercase text-white bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-4 py-1.5 mb-5">
                        <span className="text-[#25D366]">✦</span> Google ADS
                    </span>
                </motion.div>
                ...
                >
                    Let's build Google Ads campaigns that put your brand in front of ready-to-buy customers across Dubai and the GCC. Book your free Google Ads audit today — we'll show you exactly where you're leaving money on the table.
                </motion.p>
