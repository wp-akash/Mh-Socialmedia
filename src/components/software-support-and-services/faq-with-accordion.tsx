...
export default function FAQsWithAccordion() {
    const faqItems = [
        {
            id: 'item-1',
            question: 'IT Support Services',
            answer: 'Our expert IT support team is here to provide comprehensive technical support—24/7. From routine maintenance to urgent troubleshooting, we ensure your systems are secure and always operational.',
        },
        {
            id: 'item-2',
    ...
    return (
        <section className="py-16 md:py-24">
            <div className="mx-auto global-container px-4 md:px-6">
                <div className="mx-auto max-w-xl text-center">
                    <h2 className="text-balance text-3xl font-bold md:text-4xl lg:text-5xl">Service Highlights</h2>
                ...
                <div className="mx-auto mt-12 global-container">
                    <Accordion
                        type="single"
                        collapsible
