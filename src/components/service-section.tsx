        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, idx) => (
            ...
            >
              <Link target="_blank"
                href={service.href}
                className="group bg-[#fafafa] rounded-2xl p-8 flex flex-col justify-between h-full min-h-[300px] hover:-translate-y-2 hover:shadow-xl transition-all duration-300 border border-zinc-100 cursor-pointer block"
              >
