...
export default function Service_story() {
    return (
            ...
            <div className="global-container md:px-4">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> Our Services
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            We provide tailored services ranging from branding and web development to targeted ad campaigns and SEO, designed to elevate your brand&apos;s digital presence.
                        </p>
                        <Link
                            href="/contact"
                ...
                >
                    <Image
                        ...
                        alt="Our Services — Digital Agency"
                        fill
