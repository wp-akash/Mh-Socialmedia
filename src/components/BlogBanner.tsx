...
export default function BlogBanner() {
    return (
        <section className="pt-20 md:pt-28 pb-10 bg-white overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12">
                    ...
                    <div className="max-w-lg">
                        <motion.div {...fadeUp(0)}>
                            <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-widest uppercase text-zinc-500 mb-5">
                                <span className="text-[#117C75]">✦</span> BLOG
                            </span>
                        </motion.div>
                        <motion.h1
                            {...fadeUp(0.1)}
                    ...
                    >
                        <p className="text-sm text-zinc-500 leading-relaxed">
                            Stay updated with the latest digital trends, market shifts, and industry insights — giving you the knowledge to stay informed and competitive.
                        </p>
                        <Link
                            href="/contact"
